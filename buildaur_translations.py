...
"de": {
    ...
    "reinstalling" : " %sInfo:\033[0m %s-%s ist schon auf neuester Version -- Installiere neu!",
    "updating" : " %sInfo:\033[0m %s-%s wird auf %s aktualisiert",
    "error_not_found" : ":: %Fehler:\033[0m %s nicht gefunden!",
    "packages" : "Packete (%s): ",
    ...
    "error_search" : ":: %sERROR:\033[0m %s ist keine gültige Suchoption!",
